...
- [X] `Partie 4/Figure_3_influence_a.png` : corriger le titre (« saturation de τ_t ») qui contredit la courbe numérique affichée, ou n'afficher τ_t,num que pour a≤1 avec une annotation indiquant que la mesure n'est plus fiable au-delà.
...
- [X] `Partie 4/réponses-aux-questions.md` : corriger les coquilles dans les tableaux — « 4.1.47 » → 4.472, « 14.1.0 » → 14.0, « 4.1.9×10⁻² » → 4.9×10⁻².
